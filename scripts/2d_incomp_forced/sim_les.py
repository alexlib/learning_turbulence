...
problem.add_equation("dt(ω) - ν*Lap(ω) + h*Lap(Lap(ω)) + α*ω = -Adv(ω) + Fω", condition="nx != 0 or ny != 0")
...
# CFL
CFL = flow_tools.CFL(solver, initial_dt=param.dt, cadence=10, safety=param.safety,
